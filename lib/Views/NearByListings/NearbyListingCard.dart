...
class NearbyListingCard extends StatelessWidget {
  ...
  NearbyListingCard({Key key, this.id, this.reference,this.price,this.listingStatus,this.agentFullName,this.propertyLocation,this.title,this.image_path,this.property_for,this.updated_at,this.property_type,this.portals,this.portalStatus}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => ListingDetailsLandingPage(id: id,title: reference,selectedIndex: 2,)));
      },
      child: Column(
        children: [
          Padding(
