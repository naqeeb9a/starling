...
class LeadsCommonPage extends StatefulWidget {

  final String type;
  LeadsCommonPage({this.type});

  @override
  _LeadsCommonPageState createState() => _LeadsCommonPageState();
}

class _LeadsCommonPageState extends State<LeadsCommonPage> {
    ...
    try{
      ...
      if(widget.type == 'Active'){
        if(permissions.contains('leads_view_other')){
          where = '%5B%7B%22column%22:%22status%22,%22operator%22:%22in%22,%22value%22:%5B%22Active%22%5D%7D%5D';
        } else {
          where = '%5B%7B%22column%22:%22status%22,%22operator%22:%22in%22,%22value%22:%5B%22Active%22%5D%7D,%7B%22column%22:%22agent_id%22,%22operator%22:%22=%22,%22value%22:%5B%22${sharedPreferences.get('user_id')}%22%5D%7D%5D';
        }
      ...
      } else if (widget.type == 'Closed'){
        if(permissions.contains('leads_view_other')){
          where = '%5B%7B%22column%22:%22status%22,%22operator%22:%22in%22,%22value%22:%5B%22Closed%22%5D%7D%5D';
        } else {
          where = '%5B%7B%22column%22:%22status%22,%22operator%22:%22in%22,%22value%22:%5B%22Closed%22%5D%7D,%7B%22column%22:%22agent_id%22,%22operator%22:%22=%22,%22value%22:%5B%22${sharedPreferences.get('user_id')}%22%5D%7D%5D';
        }
        columns = '%5B%22id%22,%22reference%22,%22type%22,%22status%22,%22sub_status%22,%22lead_source%22,%22type%22,%22priority%22,%22is_hot_lead%22,%22enquiry_date%22,%22created_at%22,%22agent_id%22,%22listing_id%22,%22client_id%22%5D';
        include = '%5B%22agent:id,first_name,last_name,reference,phone,email%22,%22client:id,first_name,last_name,reference,mobile,phone,email,country_id%22,%22client.country:id,name,iso_code2%22%5D';
        order = '%7B%22enquiry_date%22:%22desc%22%7D';
